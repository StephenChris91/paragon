...
const ourProcess = () => {
	return (
		<>
			...
			<section className="section-area section-sp5 work-area" style={{ width: '100', backgroundImage: "url(" + bg1 + ")", backgroundRepeat: " no-repeat", backgroundPosition: "center", backgroundSize: "100%" }}>
