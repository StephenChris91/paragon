					...
					<div className="row justify-content-center">
						...
						<div className="col-lg-4 col-sm-6 mb-30">
							<div className="work-bx active">
								...
								<div className="work-content">
									<h5 className="title text-secondary mb-10">Attend Appointment</h5>
						...
						<div className="col-lg-4 col-sm-6 mb-30">
							<div className="work-bx">
								...
								<div className="work-content">
									<h5 className="title text-secondary mb-10">Begin Treatment</h5>
									<p>Begin your treatment immediately and keep in touch with our Doctors to monitor your progress.</p>
								</div>
								<Link to="/contact-us" className="btn btn-primary light">View More <i className="btn-icon-bx fas fa-chevron-right"></i></Link>
							</div>
						</div>
						<Link to="/booking" className="btn btn-primary col-lg-4">Take A Tour</Link>
					</div>
				</div>
