						...
						<div className="row align-items-center">
							...
							<div className="col-lg-6 mb-30">
								<div className="heading-bx">
									...
									<h2 className="title">A Hospital like no other</h2>
									<p>All our units are linked to an ultramodern electronic medical record software which enhances our speed of service delivery and patient confidentiality.</p>
								</div>
								<div className="row">
